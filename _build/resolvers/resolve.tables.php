...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('mspassist_core_path', null,
                    $modx->getOption('core_path') . 'components/mspassist/') . 'model/';
            $modx->addPackage('mspassist', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/mspassist/model/schema/mspassist.mysql.schema.xml';
